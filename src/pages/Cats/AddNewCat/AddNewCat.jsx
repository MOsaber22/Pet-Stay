      ...
      <div className="max-w-4xl w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-5 flex flex-col gap-4">
            ...
            <div className="w-full aspect-[4/5] rounded-[32px] border-2 border-dashed border-gray-300 bg-[#f1f5f9] flex flex-col items-center justify-center text-center p-6 cursor-pointer hover:border-teal-500 transition-colors">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="aspect-square rounded-2xl bg-[#e2e8f0] flex items-center justify-center cursor-pointer hover:bg-gray-300 transition-colors">
              ...
              <CardBody className="p-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                  <div>
                    ...
                    <input 
                      type="text" 
                      placeholder="e.g. Sir Pounce-a-lot" 
