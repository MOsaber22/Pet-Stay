        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-start">
          ...
          <div className="lg:col-span-3 bg-white dark:bg-gray-800 p-10 rounded-[2rem] shadow-sm transition-colors duration-300">
            ...
            <form className="flex flex-col gap-6" onSubmit={(e) => e.preventDefault()}>
              ...
              <button
                type="submit"
                className="mt-4 bg-[#006D77] dark:bg-teal-600 text-white py-4 px-8 rounded-xl font-bold hover:bg-[#005a62] dark:hover:bg-teal-700 flex items-center justify-center gap-3 transition-all self-start"
              >
