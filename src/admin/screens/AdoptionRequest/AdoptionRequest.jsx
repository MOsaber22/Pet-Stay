...
const AdoptionRequest = () => {
  ...
  <div className="w-full bg-[#f6f8f7] px-4 sm:px-6 lg:px-8 py-2 flex-1">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-5">
       ...
       aria-hidden="true" class="text-base" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 4v16m8-8H4"></path></svg> Export List </button>
