...
const ROWS = [
  { img: "https://i.pravatar.cc/80?img=47", name: "Sarah Jenkins", email:"sarah.j@kindredtails.com", role: "Owner", owner: true,  active: true,  date: "Oct 12, 2023" },
  { img: "https://i.pravatar.cc/80?img=47", name: "Sarah Jenkins",email:"sarah.j@kindredtails.com", role: "Owner", owner: true,  active: true,  date: "Oct 12, 2023" },
   { img: "https://i.pravatar.cc/80?img=47", name: "Sarah Jenkins",email:"sarah.j@kindredtails.com", role: "Owner", owner: true,  active: true,  date: "Oct 12, 2023" },
];
...
const INFOS = [
  { Icon: LockClosedIcon, title: "Access Control",   desc: "Owners have full administrative rights including billing access.",
     bg: "bg-orange-50",  iconBg: "bg-orange-100",  iconColor: "text-orange-500" },
  { Icon: ShieldCheckIcon,title: "Safety Protocols", desc: "All users must complete identity verification before adoption.",
     bg: "bg-teal-50",    iconBg: "bg-teal-100",    iconColor: "text-teal-600"   },
  { Icon: ClipboardDocumentListIcon, title: "Audit Logs",desc: "Account changes are recorded in the global editorial log.",
  ...
  return (
    ...
    <div className="w-full px-4 sm:px-6 lg:px-2 py-6 flex flex-col gap-5">
        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            <Typography variant="h4" className="font-extrabold text-blue-gray-900 tracking-tight">Platform Users</Typography>
          ...
          <div className="flex items-center gap-2">
            ...
            <button className="flex items-center gap-2 bg-[#1C4D3A] hover:bg-[#163829] text-white rounded-full px-5 py-2 text-sm font-semibold transition">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-[195px_1fr] gap-4">
          <Card className="bg-[#C6E8C3] shadow-none border-0 relative overflow-hidden">
            <CardBody className="p-2">
              ...
              <Typography className="text-4xl font-extrabold text-[#1A3D2A] leading-none mt-1">1,284</Typography>
        ...
        <Card className="shadow-none border border-blue-gray-50 overflow-hidden">
          <CardBody className="p-0 overflow-x-auto">
            <table className="w-full min-w-[560px] table-auto text-left">
              ...
              <tbody>
                {filtered.map(({ img, name, email, role, owner, active, date }, i) => (
                  <tr key={name} className={`hover:bg-blue-gray-50/40 transition-colors ${i < filtered.length - 1 ? "border-b border-blue-gray-50" : ""}`}>
          ...
          <CardFooter className="flex items-center justify-between border-t border-blue-gray-50 px-6 py-3">
            <Typography className="text-[10px] font-bold uppercase tracking-widest text-blue-gray-400">Showing {filtered.length} of 1,284 Users</Typography>
            <div className="flex gap-2">
              <IconButton variant="outlined" size="sm" className="rounded-full border-blue-gray-200"><ChevronLeftIcon className="h-4 w-4" /></IconButton>
              <IconButton size="sm" className="rounded-full bg-[#1C4D3A] shadow-none"><ChevronRightIcon className="h-4 w-4 text-white" /></IconButton>
            </div>
          </CardFooter>
        </Card>
